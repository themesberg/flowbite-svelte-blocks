...
<Section>
  <Footer class="bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <FooterCopyright href="/" by="Flowbite.com" year={2022} class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0"/>
    <FooterLinkGroup class="fflex justify-center items-center space-x-1">
      <FooterLink href="/">
