<script lang="ts">
	...
	let {
		...
		thumnailSize,
		...restProps
	}: { name: string; dir: string; path: string; thumnailSize?: string } = $props();
...
>
	<div
		class="flex items-center justify-between rounded-t-md border-b border-gray-200 bg-gray-50 px-5 py-2.5 dark:border-gray-700 dark:bg-gray-700"
	>
