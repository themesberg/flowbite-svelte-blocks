...
<aside
	class="mb-8 flex flex-col items-start justify-center gap-4 rounded-lg border p-4 shadow-lg sm:p-8 dark:border-gray-700 dark:bg-gray-800"
>
			...
			>
				<div data-style="clean" class="mb-3 flex items-end">
					...
					<div
						data-element="fields"
						data-stacked="false"
						class="seva-fields formkit-fields flex w-full max-w-md items-center"
					>
