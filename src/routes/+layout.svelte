	...
	<header class="sticky top-0 z-40 mx-auto w-full flex-none border-b border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-800">
		<Navbar color="default" fluid class="mx-auto flex w-full items-center justify-between px-4 py-1.5">
			...
			<NavUl
				...
				classes={{
					ul: ulClass,
					active: 'md:!pl-3 md:!py-2 lg:!pl-0 text-white bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:dark:text-primary-700 dark:bg-primary-600 lg:dark:bg-transparent cursor-default',
					nonActive:
						'md:!pl-3 md:!py-2 lg:!pl-0 text-gray-700 hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 dark:text-gray-400 lg:dark:text-white lg:dark:hover:text-primary-700 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent'
				}}
			>
			...
			<div class="ml-auto flex items-center">
				<ToolbarLink class="hidden hover:text-gray-900 sm:inline-block dark:hover:text-white" name="View on GitHub" href="https://github.com/themesberg/flowbite-svelte-blocks">
					<GitHubHome /></ToolbarLink
				>
				<ToolbarLink class="hidden hover:text-gray-900 xl:inline-block dark:hover:text-white" name="Join community on Discord" href="https://discord.gg/4eeurUVvTy"><Discord /></ToolbarLink>
			...
			<a href="https://www.npmjs.com/package/flowbite-svelte-blocks" class="hidden sm:block">
				<DocBadge class="hover:bg-primary-600 dark:hover:bg-primary-800 ml-2 hover:text-white xl:ml-6 dark:hover:text-white">
					v{version}
				</DocBadge>
			</a>
...
<aside class="bg-gray-50 py-16 lg:py-20 dark:bg-gray-800">
	<div class="max-w-8xl mx-auto px-4">
		<h2 class="mb-4 text-4xl font-bold tracking-tight text-gray-900 md:text-center md:font-extrabold lg:mb-7 lg:leading-none dark:text-white">Sign up for our newsletter</h2>
		<p class="mb-6 text-base text-gray-500 md:mb-10 md:text-center md:text-xl lg:px-20 xl:px-56 dark:text-gray-400">
				...
				<div class="w-full">
					...
					<div class="relative h-full">
						<div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="h-5 w-5 text-gray-500 dark:text-gray-400"
		...
		<p class="text-sm text-gray-500 md:text-center dark:text-gray-400">
			By subscribing, you agree with Revue’s <a rel="nofollow noopener noreferrer" class="text-primary-600 dark-text-primary-400 hover:underline" href="https://www.getrevue.co/terms"
				>Terms of Service</a
			>
			and
			<a class="dark-text-blue-400 text-blue-600 hover:underline" rel="nofollow noopener noreferrer" href="https://www.getrevue.co/privacy">Privacy Policy</a>.
		</p>
	</div>
</aside>
