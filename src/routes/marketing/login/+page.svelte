...
<SectionHeader>
	<Breadcrumb navClass="flex mb-3">
		...
		<BreadcrumbItem>Login Forms</BreadcrumbItem>
	</Breadcrumb>
	<svelte:fragment slot="h1">Tailwind CSS Login Form - Flowbite-Svelte-Blocks</svelte:fragment>
	<svelte:fragment slot="paragraph"
		>The login page can be used to allow users to authenticate inside your application based on a
		collection of templates from Flowbite and coded with Tailwind CSS.</svelte:fragment
	>
</SectionHeader>
...
<Section name="none" classSection="py-6 sm:py-10" classDiv="px-4 mx-auto max-w-8xl">
	<div class="grid lg:grid-cols-2">
		<div>
			...
			<EditOnGithub
				size="18"
				href="https://github.com/shinokada/flowbite-svelte-blocks/blob/main/src/routes/marketing/login/+page.svelte"
