...
<Section name="testimonial">
	...
	<div class="mb-8 grid lg:mb-12 lg:grid-cols-2">
		<TestimonialCardItem>
			...
			<p class="my-4">
				Flowbite has code in one place and I'm not joking when I say it took me a matter of minutes
				to copy the code, customise it and integrate within a Laravel + Vue application.
			</p>
