...
[Demo](https://flowbite-svelte-blocks.vercel.app/marketing/faq)
...
<Faq>
  <div>
    ...
    <FaqItem>
      ...
      >
      <p class="text-gray-500 dark:text-gray-400">
        You can use Windster for an unlimited amount of projects, whether it's a personal website, a
  ...
  <div>
    ...
    <FaqItem>
      ...
      <p class="text-gray-500 dark:text-gray-400">
        ...
        difference is in the design, the pages, the extra components and UI elements that Windster
        includes.
      </p>
      <p class="text-gray-500 dark:text-gray-400">
        Additionally, Windster is a project that is still in development, and later it will include
