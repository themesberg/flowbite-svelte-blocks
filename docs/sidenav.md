...
[Demo](https://flowbite-svelte-blocks.vercel.app/application/sidenav)
    ...
    <SidebarWrapper>
      ...
      <SidebarGroup class='relative pt-64'>
        <SidebarBottomNav>
          ...
          <Button color='dark' id='countries' class='inline-flex justify-center p-2 text-gray-500 rounded cursor-pointer dark:hover:text-white dark:text-gray-400 hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600'>
