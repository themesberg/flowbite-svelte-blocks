...
test('account-recovery page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS Account Recovery Form - Flowbite-Svelte-Blocks'
  );
});
...
test('content page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS Content Sections - Flowbite-Svelte-Blocks'
  );
});
...
test('feature page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS Feature Sections - Flowbite-Svelte-Blocks'
  );
});
...
test('footer page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS Footer Sections - Flowbite-Svelte-Blocks'
  );
});
...
test('maintenance page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS Maintenance Pages - Flowbite-Svelte-Blocks'
  );
});
...
test('Reset Password page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS Reset Password Form - Flowbite-Svelte-Blocks'
  );
});
...
test('User Onboarding page has expected h1', async ({ page }) => {
  ...
  expect(await page.textContent('h1')).toBe(
    'Tailwind CSS User Onboarding - Flowbite-Svelte-Blocks'
  );
});
